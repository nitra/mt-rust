...
| Г | `mt-napi` | Видаляється повністю — підтверджено відсутність інших споживачів (VS Code extension тощо не існує). ⚠️ Це рішення **скасовувалось і відновлювалось**: [2026-07-27](2026-07-27-mt-napi-binding.md) повернула крейт заради `@7n/rules`, але той 2026-07-30 зробив власний `rules-napi`. Чинний стан із 2026-08-09 — знову видалено, тепер бо споживач так і не з'явився. |
